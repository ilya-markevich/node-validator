...
const errorMessageTestCases = [
  ...
  generateErrorMessageData("each value should be in [null, undefined]", [
    null,
    undefined,
  ]),
  generateErrorMessageData("each value should be in [true, false]", [
    true,
    false,
  ]),
  generateErrorMessageData("each value should be in [test1, test2]", [
    "test1",
    "test2",
  ]),
];
