...
const executeTestCases = [
  generateExecuteData(false, null, { min: 0 }),
  generateExecuteData(true, [], { min: null, max: null }),
  generateExecuteData(true, [], { min: 0 }),
  generateExecuteData(false, [], { min: 1 }),
  generateExecuteData(true, [1, 2, 3], { min: 3, max: 5 }),
  generateExecuteData(false, [1, 2, 3], { min: 4 }),
  generateExecuteData(true, [1], { max: 2 }),
  generateExecuteData(false, [1, 2, 3], { max: 2 }),
];
