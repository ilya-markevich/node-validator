...
const executeTestCases = [
  ...
  generateExecuteData(true, "192.168.1.1", { v4: true }),
...
const errorMessageTestCases = [
  ...
  generateErrorMessageData("should be an ip string", { v4: true, v6: true }),
  generateErrorMessageData("should be an ipv4 string", { v4: true }),
  generateErrorMessageData("should be an ipv6 string", { v6: true }),
];
