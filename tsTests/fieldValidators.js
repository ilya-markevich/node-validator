...
function isArrayLength(validator) {
...
function isBase64String(validator) {
...
function isIn(validator) {
    validator.property('prop1').isIn(['test']).optional();
}
function isInteger(validator) {
...
function isJsonString(validator) {
    validator.property('prop1').isJsonString().optional();
}
function isLength(validator) {
